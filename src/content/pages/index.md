...
faq:
  ...
  - q: Why does my text look different on my friend's phone?
    a: >-
      ...
      styled text arrived intact, and your friend's device simply renders it with
      different designs, or shows squares (□) if it's older and missing those
      characters.
...
# Temporary relatedTools test data for Phase 4. phase-1-test exists;
# cursive-font-generator and gothic-font-generator do not, and must be omitted.
relatedTools:
  - phase-1-test
...
ARTICLE_BODY_NOT_YET_CONVERTED_DO_NOT_WRITE_PROSE_HERE
